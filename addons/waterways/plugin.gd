...
func _on_generate_path_pressed() -> void:
	_edited_node.spawn_path()
...
func _show_river_control_panel() -> void:
	if not _river_controls.get_parent():
		...
		_river_controls.menu.connect("generate_path", self, "_on_generate_path_pressed")
...
func _hide_river_control_panel() -> void:
	if _river_controls.get_parent():
		...
		_river_controls.menu.disconnect("generate_path", self, "_on_generate_path_pressed")
